  ...
  public function save(array $form, FormStateInterface $form_state): int {
    ...
    switch ($result) {
      case SAVED_NEW:
        ...
        $this->logger('speaker')->notice('New speaker profile %label has been created.', $logger_args);
        break;

      case SAVED_UPDATED:
        $this->messenger()->addStatus($this->t('The speaker profile %label has been updated.', $message_args));
        $this->logger('speaker')->notice('The speaker profile %label has been updated.', $logger_args);
        break;
